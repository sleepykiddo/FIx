...
#define SDL_TriggerBreakpoint()                   \
    __builtin_trap() /* older gcc may not support \
                        SDL_HAS_BUILTIN(__builtin_trap) above */
...
typedef struct SDL_AssertData {
    bool always_ignore; /**< true if app should always continue when assertion
                           is triggered. */
    unsigned int trigger_count; /**< Number of times this assertion has been
                                   triggered. */
    ...
    const char*
        function; /**< The name of the function where this assert lives. */
 ...
 */
extern SDL_DECLSPEC SDL_AssertState SDLCALL
...
#define SDL_assert(condition)               \
    if (assertion_enabled && (condition)) { \
        trigger_assertion;                  \
    }
 ...
 * \sa SDL_GetAssertionHandler
 */
extern SDL_DECLSPEC SDL_AssertionHandler SDLCALL
