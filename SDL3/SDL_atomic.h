...
#elif (defined(__GNUC__) && !defined(SDL_PLATFORM_EMSCRIPTEN)) || \
 ...
 * \sa SDL_SetAtomicInt
 */
extern SDL_DECLSPEC bool SDLCALL SDL_CompareAndSwapAtomicInt(SDL_AtomicInt* a,
                                                             int oldval,
                                                             int newval);
 ...
 * \sa SDL_SetAtomicU32
 */
extern SDL_DECLSPEC bool SDLCALL SDL_CompareAndSwapAtomicU32(SDL_AtomicU32* a,
                                                             Uint32 oldval,
                                                             Uint32 newval);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_CompareAndSwapAtomicPointer(void** a,
                                                                 void* oldval,
                                                                 void* newval);
