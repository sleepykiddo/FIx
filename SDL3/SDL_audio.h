...
#define SDL_DEFINE_AUDIO_FORMAT(signed, bigendian, flt, size) \
    (((Uint16)(signed) << 15) | ((Uint16)(bigendian) << 12) | \
     ((Uint16)(flt) << 8) | ((size) & SDL_AUDIO_MASK_BITSIZE))
 ...
 */
extern SDL_DECLSPEC SDL_AudioDeviceID* SDLCALL
...
SDL_GetAudioDeviceName(SDL_AudioDeviceID devid);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetAudioDeviceFormat(
    SDL_AudioDeviceID devid, SDL_AudioSpec* spec, int* sample_frames);
...
SDL_GetAudioDeviceChannelMap(SDL_AudioDeviceID devid, int* count);
 ...
 */
extern SDL_DECLSPEC SDL_AudioDeviceID SDLCALL
SDL_OpenAudioDevice(SDL_AudioDeviceID devid, const SDL_AudioSpec* spec);
...
SDL_IsAudioDevicePhysical(SDL_AudioDeviceID devid);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_IsAudioDevicePlayback(SDL_AudioDeviceID devid);
...
SDL_GetAudioDeviceGain(SDL_AudioDeviceID devid);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioDeviceGain(SDL_AudioDeviceID devid,
                                                        float gain);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_BindAudioStreams(
    SDL_AudioDeviceID devid, SDL_AudioStream* const* streams, int num_streams);
 ...
 * \sa SDL_GetAudioStreamDevice
 */
extern SDL_DECLSPEC bool SDLCALL SDL_BindAudioStream(SDL_AudioDeviceID devid,
...
SDL_UnbindAudioStreams(SDL_AudioStream* const* streams, int num_streams);
 ...
 */
extern SDL_DECLSPEC SDL_AudioDeviceID SDLCALL
SDL_GetAudioStreamDevice(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC SDL_AudioStream* SDLCALL SDL_CreateAudioStream(
...
SDL_GetAudioStreamProperties(SDL_AudioStream* stream);
 ...
 * \sa SDL_SetAudioStreamFormat
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetAudioStreamFormat(
    SDL_AudioStream* stream, SDL_AudioSpec* src_spec, SDL_AudioSpec* dst_spec);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetAudioStreamFormat(SDL_AudioStream* stream, const SDL_AudioSpec* src_spec,
 ...
 */
extern SDL_DECLSPEC float SDLCALL
SDL_GetAudioStreamFrequencyRatio(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetAudioStreamFrequencyRatio(SDL_AudioStream* stream, float ratio);
 ...
 */
extern SDL_DECLSPEC float SDLCALL
SDL_GetAudioStreamGain(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioStreamGain(SDL_AudioStream* stream,
                                                        float gain);
 ...
 */
extern SDL_DECLSPEC int* SDLCALL
SDL_GetAudioStreamInputChannelMap(SDL_AudioStream* stream, int* count);
 ...
 */
extern SDL_DECLSPEC int* SDLCALL
SDL_GetAudioStreamOutputChannelMap(SDL_AudioStream* stream, int* count);
 ...
 * \sa SDL_SetAudioStreamInputChannelMap
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioStreamInputChannelMap(
 ...
 * \sa SDL_SetAudioStreamInputChannelMap
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioStreamOutputChannelMap(
    SDL_AudioStream* stream, const int* chmap, int count);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_PutAudioStreamData(SDL_AudioStream* stream,
                                                        const void* buf,
                                                        int len);
 ...
 * \sa SDL_PutAudioStreamData
 */
extern SDL_DECLSPEC int SDLCALL SDL_GetAudioStreamData(SDL_AudioStream* stream,
                                                       void* buf, int len);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetAudioStreamAvailable(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetAudioStreamQueued(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_ResumeAudioStreamDevice(SDL_AudioStream* stream);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_AudioStreamDevicePaused(SDL_AudioStream* stream);
 ...
 * \sa SDL_SetAudioStreamPutCallback
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioStreamGetCallback(
 ...
 * \sa SDL_SetAudioStreamGetCallback
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioStreamPutCallback(
    SDL_AudioStream* stream, SDL_AudioStreamCallback callback, void* userdata);
 ...
 * \sa SDL_ResumeAudioStreamDevice
 */
extern SDL_DECLSPEC SDL_AudioStream* SDLCALL
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAudioPostmixCallback(
    SDL_AudioDeviceID devid, SDL_AudioPostmixCallback callback, void* userdata);
 ...
 * \sa SDL_LoadWAV
 */
extern SDL_DECLSPEC bool SDLCALL SDL_LoadWAV_IO(SDL_IOStream* src, bool closeio,
                                                SDL_AudioSpec* spec,
                                                Uint8** audio_buf,
                                                Uint32* audio_len);
 ...
 * \sa SDL_LoadWAV_IO
 */
extern SDL_DECLSPEC bool SDLCALL SDL_LoadWAV(const char* path,
                                             SDL_AudioSpec* spec,
                                             Uint8** audio_buf,
                                             Uint32* audio_len);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_MixAudio(Uint8* dst, const Uint8* src,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ConvertAudioSamples(
    const SDL_AudioSpec* src_spec, const Uint8* src_data, int src_len,
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetAudioFormatName(SDL_AudioFormat format);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetSilenceValueForFormat(SDL_AudioFormat format);
