...
typedef struct SDL_CameraSpec {
    ...
    int framerate_numerator;   /**< Frame rate numerator ((num / denom) == FPS,
                                  (denom / num) == duration in seconds) */
    int framerate_denominator; /**< Frame rate demoninator ((num / denom) ==
                                  FPS, (denom / num) == duration in seconds) */
} SDL_CameraSpec;
 ...
 * \sa SDL_OpenCamera
 */
extern SDL_DECLSPEC SDL_CameraSpec** SDLCALL
SDL_GetCameraSupportedFormats(SDL_CameraID instance_id, int* count);
...
SDL_GetCameraName(SDL_CameraID instance_id);
 ...
 * \sa SDL_GetCameras
 */
extern SDL_DECLSPEC SDL_CameraPosition SDLCALL
SDL_GetCameraPosition(SDL_CameraID instance_id);
 ...
 * \sa SDL_GetCameraFormat
 */
extern SDL_DECLSPEC SDL_Camera* SDLCALL
SDL_OpenCamera(SDL_CameraID instance_id, const SDL_CameraSpec* spec);
...
SDL_GetCameraPermissionState(SDL_Camera* camera);
...
SDL_GetCameraProperties(SDL_Camera* camera);
 ...
 * \sa SDL_OpenCamera
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetCameraFormat(SDL_Camera* camera,
                                                     SDL_CameraSpec* spec);
 ...
 */
extern SDL_DECLSPEC SDL_Surface* SDLCALL
SDL_AcquireCameraFrame(SDL_Camera* camera, Uint64* timestampNS);
 ...
 */
extern SDL_DECLSPEC void SDLCALL SDL_ReleaseCameraFrame(SDL_Camera* camera,
                                                        SDL_Surface* frame);
