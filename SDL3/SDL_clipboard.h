 ...
 */
typedef const void*(SDLCALL* SDL_ClipboardDataCallback)(void* userdata,
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetClipboardData(
    SDL_ClipboardDataCallback callback, SDL_ClipboardCleanupCallback cleanup,
    void* userdata, const char** mime_types, size_t num_mime_types);
 ...
 * \sa SDL_SetClipboardData
 */
extern SDL_DECLSPEC void* SDLCALL SDL_GetClipboardData(const char* mime_type,
                                                       size_t* size);
...
SDL_GetClipboardMimeTypes(size_t* num_mime_types);
