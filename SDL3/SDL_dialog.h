 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
extern SDL_DECLSPEC void SDLCALL SDL_ShowOpenFileDialog(
...
SDL_ShowSaveFileDialog(SDL_DialogFileCallback callback, void* userdata,
 ...
 * \sa SDL_ShowFileDialogWithProperties
 */
extern SDL_DECLSPEC void SDLCALL SDL_ShowOpenFolderDialog(
    SDL_DialogFileCallback callback, void* userdata, SDL_Window* window,
    const char* default_location, bool allow_many);
 ...
 * \sa SDL_ShowOpenFolderDialog
 */
extern SDL_DECLSPEC void SDLCALL SDL_ShowFileDialogWithProperties(
    SDL_FileDialogType type, SDL_DialogFileCallback callback, void* userdata,
