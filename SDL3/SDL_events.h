...
typedef enum SDL_EventType {
    ...
    SDL_EVENT_TERMINATING, /**< The application is being terminated by the OS.
                              ...
                              onDestroy()
                           */
    SDL_EVENT_LOW_MEMORY,  /**< The application is low on memory, free memory if
                           ...
                           */
    SDL_EVENT_WILL_ENTER_BACKGROUND, /**< The application is about to enter the
                                     ...
                                     Android in onPause()
                                */
    SDL_EVENT_DID_ENTER_BACKGROUND,  /**< The application did enter the
                                      ...
                                      Android in onPause()
                                 */
    SDL_EVENT_WILL_ENTER_FOREGROUND, /**< The application is about to enter the
    ...
    SDL_EVENT_DID_ENTER_FOREGROUND,  /**< The application is now interactive.
                                      ...
                                      set with SDL_AddEventWatch().  Called on iOS
                                      in applicationDidBecomeActive()  Called on
                                      Android in onResume()
                                 */
    ...
    SDL_EVENT_DISPLAY_ORIENTATION =
        0x151,                 /**< Display orientation has changed to data1 */
    SDL_EVENT_DISPLAY_ADDED,   /**< Display has been added to the system */
    SDL_EVENT_DISPLAY_REMOVED, /**< Display has been removed from the system */
    SDL_EVENT_DISPLAY_MOVED,   /**< Display has changed position */
    SDL_EVENT_DISPLAY_DESKTOP_MODE_CHANGED,  /**< Display has changed desktop
                                                mode */
    SDL_EVENT_DISPLAY_CURRENT_MODE_CHANGED,  /**< Display has changed current
                                                mode */
    ...
    SDL_EVENT_WINDOW_PIXEL_SIZE_CHANGED, /**< The pixel size of the window has
                                            changed to data1xdata2 */
    SDL_EVENT_WINDOW_METAL_VIEW_RESIZED, /**< The pixel size of a Metal view
                                            associated with the window has
                                            changed */
    SDL_EVENT_WINDOW_MINIMIZED,          /**< Window has been minimized */
    SDL_EVENT_WINDOW_MAXIMIZED,          /**< Window has been maximized */
    SDL_EVENT_WINDOW_RESTORED, /**< Window has been restored to normal size and
                                  position */
    SDL_EVENT_WINDOW_MOUSE_ENTER,     /**< Window has gained mouse focus */
    SDL_EVENT_WINDOW_MOUSE_LEAVE,     /**< Window has lost mouse focus */
    SDL_EVENT_WINDOW_FOCUS_GAINED,    /**< Window has gained keyboard focus */
    SDL_EVENT_WINDOW_FOCUS_LOST,      /**< Window has lost keyboard focus */
    SDL_EVENT_WINDOW_CLOSE_REQUESTED, /**< The window manager requests that the
                                         window be closed */
    SDL_EVENT_WINDOW_HIT_TEST,        /**< Window had a hit test that wasn't
                                         SDL_HITTEST_NORMAL */
    SDL_EVENT_WINDOW_ICCPROF_CHANGED, /**< The ICC profile of the window's
                                         display has changed */
    SDL_EVENT_WINDOW_DISPLAY_CHANGED, /**< Window has been moved to display
                                         data1 */
    ...
    SDL_EVENT_WINDOW_LEAVE_FULLSCREEN, /**< The window has left fullscreen mode
                                        */
    SDL_EVENT_WINDOW_DESTROYED, /**< The window with the associated ID is being
    ...
    SDL_EVENT_KEYMAP_CHANGED, /**< Keymap changed due to a system event such as
    ...
    SDL_EVENT_GAMEPAD_ADDED,    /**< A new gamepad has been inserted into the
                                   system */
    ...
    SDL_EVENT_GAMEPAD_STEAM_HANDLE_UPDATED, /**< Gamepad Steam handle has
                                               changed */
    ...
    SDL_EVENT_DROP_BEGIN, /**< A new set of drops is beginning (NULL filename)
                           */
    SDL_EVENT_DROP_COMPLETE, /**< Current set of drops is now complete (NULL
                                filename) */
    ...
    SDL_EVENT_AUDIO_DEVICE_FORMAT_CHANGED, /**< An audio device's format has
    ...
    SDL_EVENT_PEN_PROXIMITY_IN =
        0x1300, /**< Pressure-sensitive pen has become available */
    ...
    SDL_EVENT_PEN_UP,   /**< Pressure-sensitive pen stopped touching drawing
                           surface */
    ...
    SDL_EVENT_CAMERA_DEVICE_ADDED =
        0x1400,                       /**< A new camera device is available */
    SDL_EVENT_CAMERA_DEVICE_REMOVED,  /**< A camera device has been removed. */
    SDL_EVENT_CAMERA_DEVICE_APPROVED, /**< A camera device has been approved for
                                         use by the user. */
    SDL_EVENT_CAMERA_DEVICE_DENIED, /**< A camera device has been denied for use
                                       by the user. */

    /* Render events */
    SDL_EVENT_RENDER_TARGETS_RESET =
        0x2000, /**< The render targets have been reset and their contents need
                   to be updated */
    SDL_EVENT_RENDER_DEVICE_RESET, /**< The device has been reset and all
...
typedef struct SDL_TextEditingEvent {
    ...
    Sint32 start;  /**< The start cursor of selected editing text, or -1 if not
                      set */
...
typedef struct SDL_TextEditingCandidatesEvent {
    ...
    Sint32 selected_candidate; /**< The index of the selected candidate, or -1
...
typedef struct SDL_MouseWheelEvent {
    ...
    Sint32 integer_x; /**< The amount scrolled horizontally, accumulated to
                         whole scroll "ticks" (added in 3.2.12) */
    Sint32 integer_y; /**< The amount scrolled vertically, accumulated to whole
...
typedef struct SDL_GamepadSensorEvent {
    ...
    float data[3];           /**< Up to 3 values from the sensor, as defined in
                                SDL_sensor.h */
    Uint64 sensor_timestamp; /**< The timestamp of the sensor reading in
...
typedef struct SDL_SensorEvent {
    ...
    float data[6]; /**< Up to 6 values from the sensor - additional values can
...
typedef struct SDL_UserEvent {
    Uint32 type; /**< SDL_EVENT_USER through SDL_EVENT_LAST-1, Uint32 because
                    these are not in the SDL_EventType enumeration */
    Uint32 reserved;
    Uint64 timestamp; /**< In nanoseconds, populated using SDL_GetTicksNS() */
 ...
 * \sa SDL_PushEvent
 */
extern SDL_DECLSPEC int SDLCALL SDL_PeepEvents(SDL_Event* events, int numevents,
 ...
 * \sa SDL_WaitEvent
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WaitEventTimeout(SDL_Event* event,
                                                      Sint32 timeoutMS);
 ...
 * \sa SDL_PushEvent
 */
extern SDL_DECLSPEC void SDLCALL SDL_SetEventFilter(SDL_EventFilter filter,
                                                    void* userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetEventFilter(SDL_EventFilter* filter,
                                                    void** userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC bool SDLCALL SDL_AddEventWatch(SDL_EventFilter filter,
                                                   void* userdata);
 ...
 * \sa SDL_AddEventWatch
 */
extern SDL_DECLSPEC void SDLCALL SDL_RemoveEventWatch(SDL_EventFilter filter,
                                                      void* userdata);
 ...
 * \sa SDL_SetEventFilter
 */
extern SDL_DECLSPEC void SDLCALL SDL_FilterEvents(SDL_EventFilter filter,
                                                  void* userdata);
 ...
 * \sa SDL_WaitEventTimeout
 */
extern SDL_DECLSPEC SDL_Window* SDLCALL
SDL_GetWindowFromEvent(const SDL_Event* event);
