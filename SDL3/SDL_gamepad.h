...
typedef enum SDL_GamepadButton {
    ...
    SDL_GAMEPAD_BUTTON_MISC1, /**< Additional button (e.g. Xbox Series X share
                                 button, PS5 microphone button, Nintendo Switch
                                 Pro capture button, Amazon Luna microphone
                                 button, Google Stadia capture button) */
    SDL_GAMEPAD_BUTTON_RIGHT_PADDLE1, /**< Upper or primary paddle, under your
                                         right hand (e.g. Xbox Elite paddle P1)
                                       */
    SDL_GAMEPAD_BUTTON_LEFT_PADDLE1,  /**< Upper or primary paddle, under your
                                         left hand (e.g. Xbox Elite paddle P3) */
    SDL_GAMEPAD_BUTTON_RIGHT_PADDLE2, /**< Lower or secondary paddle, under your
                                         right hand (e.g. Xbox Elite paddle P2)
                                       */
    SDL_GAMEPAD_BUTTON_LEFT_PADDLE2,  /**< Lower or secondary paddle, under your
 ...
 * \sa SDL_IsGamepad
 */
extern SDL_DECLSPEC SDL_Gamepad* SDLCALL
...
SDL_GetGamepadProperties(SDL_Gamepad* gamepad);
...
SDL_GetGamepadID(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetGamepadName(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetGamepadPath(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC SDL_GamepadType SDLCALL
SDL_GetGamepadType(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC SDL_GamepadType SDLCALL
SDL_GetRealGamepadType(SDL_Gamepad* gamepad);
 ...
 * \sa SDL_GetGamepadPlayerIndex
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetGamepadPlayerIndex(SDL_Gamepad* gamepad,
                                                           int player_index);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetGamepadProductVersion(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetGamepadFirmwareVersion(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetGamepadSerial(SDL_Gamepad* gamepad);
...
SDL_GetGamepadSteamHandle(SDL_Gamepad* gamepad);
...
SDL_GetGamepadConnectionState(SDL_Gamepad* gamepad);
...
SDL_GetGamepadPowerInfo(SDL_Gamepad* gamepad, int* percent);
...
SDL_GetGamepadBindings(SDL_Gamepad* gamepad, int* count);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GamepadHasAxis(SDL_Gamepad* gamepad,
                                                    SDL_GamepadAxis axis);
 ...
 */
extern SDL_DECLSPEC Sint16 SDLCALL SDL_GetGamepadAxis(SDL_Gamepad* gamepad,
                                                      SDL_GamepadAxis axis);
 ...
 * \sa SDL_GamepadHasAxis
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GamepadHasButton(SDL_Gamepad* gamepad,
                                                      SDL_GamepadButton button);
 ...
 * \sa SDL_GetGamepadAxis
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetGamepadButton(SDL_Gamepad* gamepad,
                                                      SDL_GamepadButton button);
 ...
 */
extern SDL_DECLSPEC SDL_GamepadButtonLabel SDLCALL
SDL_GetGamepadButtonLabel(SDL_Gamepad* gamepad, SDL_GamepadButton button);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetNumGamepadTouchpads(SDL_Gamepad* gamepad);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetNumGamepadTouchpadFingers(SDL_Gamepad* gamepad, int touchpad);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_GetGamepadTouchpadFinger(SDL_Gamepad* gamepad, int touchpad, int finger,
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GamepadHasSensor(SDL_Gamepad* gamepad,
                                                      SDL_SensorType type);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetGamepadSensorEnabled(
    SDL_Gamepad* gamepad, SDL_SensorType type, bool enabled);
 ...
 * \sa SDL_SetGamepadSensorEnabled
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GamepadSensorEnabled(SDL_Gamepad* gamepad,
                                                          SDL_SensorType type);
...
SDL_GetGamepadSensorDataRate(SDL_Gamepad* gamepad, SDL_SensorType type);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetGamepadSensorData(SDL_Gamepad* gamepad,
                                                          SDL_SensorType type,
                                                          float* data,
                                                          int num_values);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_RumbleGamepad(SDL_Gamepad* gamepad,
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_RumbleGamepadTriggers(SDL_Gamepad* gamepad,
                                                           Uint16 left_rumble,
                                                           Uint16 right_rumble,
                                                           Uint32 duration_ms);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetGamepadLED(SDL_Gamepad* gamepad,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SendGamepadEffect(SDL_Gamepad* gamepad,
                                                       const void* data,
                                                       int size);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetGamepadAppleSFSymbolsNameForButton(SDL_Gamepad* gamepad,
                                          SDL_GamepadButton button);
...
extern SDL_DECLSPEC const char* SDLCALL SDL_GetGamepadAppleSFSymbolsNameForAxis(
    SDL_Gamepad* gamepad, SDL_GamepadAxis axis);
