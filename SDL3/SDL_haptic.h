...
SDL_GetHapticNameForID(SDL_HapticID instance_id);
 ...
 * \sa SDL_SetHapticGain
 */
extern SDL_DECLSPEC SDL_Haptic* SDLCALL
SDL_OpenHaptic(SDL_HapticID instance_id);
 ...
 */
extern SDL_DECLSPEC SDL_Haptic* SDLCALL
SDL_GetHapticFromID(SDL_HapticID instance_id);
 ...
 */
extern SDL_DECLSPEC SDL_Haptic* SDLCALL
SDL_OpenHapticFromJoystick(SDL_Joystick* joystick);
...
SDL_GetMaxHapticEffectsPlaying(SDL_Haptic* haptic);
...
SDL_HapticEffectSupported(SDL_Haptic* haptic, const SDL_HapticEffect* effect);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_CreateHapticEffect(SDL_Haptic* haptic, const SDL_HapticEffect* effect);
 ...
 * \sa SDL_RunHapticEffect
 */
extern SDL_DECLSPEC bool SDLCALL SDL_UpdateHapticEffect(
    SDL_Haptic* haptic, int effect, const SDL_HapticEffect* data);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL SDL_RunHapticEffect(SDL_Haptic* haptic,
                                                     int effect,
                                                     Uint32 iterations);
 ...
 * \sa SDL_StopHapticEffects
 */
extern SDL_DECLSPEC bool SDLCALL SDL_StopHapticEffect(SDL_Haptic* haptic,
                                                      int effect);
 ...
 * \sa SDL_CreateHapticEffect
 */
extern SDL_DECLSPEC void SDLCALL SDL_DestroyHapticEffect(SDL_Haptic* haptic,
                                                         int effect);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetHapticEffectStatus(SDL_Haptic* haptic,
                                                           int effect);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetHapticGain(SDL_Haptic* haptic,
                                                   int gain);
 ...
 * \sa SDL_GetHapticFeatures
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetHapticAutocenter(SDL_Haptic* haptic,
                                                         int autocenter);
 ...
 * \sa SDL_StopHapticRumble
 */
extern SDL_DECLSPEC bool SDLCALL SDL_PlayHapticRumble(SDL_Haptic* haptic,
                                                      float strength,
                                                      Uint32 length);
