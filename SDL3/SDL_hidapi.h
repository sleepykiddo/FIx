 ...
 */
extern SDL_DECLSPEC SDL_hid_device_info* SDLCALL
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC SDL_hid_device* SDLCALL
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_write(SDL_hid_device* dev,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_read_timeout(SDL_hid_device* dev,
                                                     unsigned char* data,
                                                     size_t length,
                                                     int milliseconds);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_read(SDL_hid_device* dev,
                                             unsigned char* data,
                                             size_t length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_set_nonblocking(SDL_hid_device* dev,
                                                        int nonblock);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_send_feature_report(
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_feature_report(SDL_hid_device* dev,
                                                           unsigned char* data,
                                                           size_t length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_input_report(SDL_hid_device* dev,
                                                         unsigned char* data,
                                                         size_t length);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_manufacturer_string(
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_product_string(SDL_hid_device* dev,
                                                           wchar_t* string,
                                                           size_t maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_serial_number_string(
    SDL_hid_device* dev, wchar_t* string, size_t maxlen);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_indexed_string(SDL_hid_device* dev,
                                                           int string_index,
                                                           wchar_t* string,
                                                           size_t maxlen);
 ...
 */
extern SDL_DECLSPEC SDL_hid_device_info* SDLCALL
SDL_hid_get_device_info(SDL_hid_device* dev);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_hid_get_report_descriptor(
    SDL_hid_device* dev, unsigned char* buf, size_t buf_size);
