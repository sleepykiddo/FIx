...
#define SDL_INIT_AUDIO \
    0x00000010u /**< `SDL_INIT_AUDIO` implies `SDL_INIT_EVENTS` */
#define SDL_INIT_VIDEO                                                     \
    0x00000020u /**< `SDL_INIT_VIDEO` implies `SDL_INIT_EVENTS`, should be \
                   initialized on the main thread */
#define SDL_INIT_JOYSTICK \
    0x00000200u /**< `SDL_INIT_JOYSTICK` implies `SDL_INIT_EVENTS` */
#define SDL_INIT_HAPTIC 0x00001000u
#define SDL_INIT_GAMEPAD \
    0x00002000u /**< `SDL_INIT_GAMEPAD` implies `SDL_INIT_JOYSTICK` */
#define SDL_INIT_EVENTS 0x00004000u
#define SDL_INIT_SENSOR \
    0x00008000u /**< `SDL_INIT_SENSOR` implies `SDL_INIT_EVENTS` */
#define SDL_INIT_CAMERA \
    0x00010000u /**< `SDL_INIT_CAMERA` implies `SDL_INIT_EVENTS` */
...
typedef enum SDL_AppResult {
    SDL_APP_CONTINUE, /**< Value that requests that the app continue from the
                         main callbacks. */
    SDL_APP_SUCCESS,  /**< Value that requests termination with success from the
                         main callbacks. */
    SDL_APP_FAILURE   /**< Value that requests termination with error from the
                         main callbacks. */
} SDL_AppResult;
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
typedef SDL_AppResult(SDLCALL* SDL_AppInit_func)(void** appstate, int argc,
                                                 char* argv[]);
 ...
 * \since This datatype is available since SDL 3.2.0.
 */
typedef SDL_AppResult(SDLCALL* SDL_AppEvent_func)(void* appstate,
                                                  SDL_Event* event);
 ...
 * \sa SDL_IsMainThread
 */
extern SDL_DECLSPEC bool SDLCALL SDL_RunOnMainThread(
    SDL_MainThreadCallback callback, void* userdata, bool wait_complete);
 ...
 * \sa SDL_SetAppMetadataProperty
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAppMetadata(const char* appname,
 ...
 * \sa SDL_SetAppMetadata
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetAppMetadataProperty(const char* name,
                                                            const char* value);
...
SDL_GetAppMetadataProperty(const char* name);
