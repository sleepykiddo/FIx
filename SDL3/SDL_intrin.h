 ...
 * 4392, so you need to explicitly define SDL_ENABLE_ALTIVEC to have it
 * included. */
...
#define SDL_HAS_TARGET_ATTRIBS
    ...
    (__GNUC__ + (__GNUC_MINOR__ >= 9) > 4) /* gcc >= 4.9 */
#define SDL_HAS_TARGET_ATTRIBS
...
#include <lasxintrin.h>
    ...
    defined(_M_IX86)
#if ((defined(_MSC_VER) && !defined(_M_X64)) || defined(__MMX__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&                            \
    !defined(SDL_DISABLE_MMX)
#define SDL_MMX_INTRINSICS 1
#include <mmintrin.h>
#endif
#if (defined(_MSC_VER) || defined(__SSE__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&      \
    !defined(SDL_DISABLE_SSE)
#define SDL_SSE_INTRINSICS 1
#include <xmmintrin.h>
#endif
#if (defined(_MSC_VER) || defined(__SSE2__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&       \
    !defined(SDL_DISABLE_SSE2)
#define SDL_SSE2_INTRINSICS 1
#include <emmintrin.h>
#endif
#if (defined(_MSC_VER) || defined(__SSE3__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&       \
    !defined(SDL_DISABLE_SSE3)
#define SDL_SSE3_INTRINSICS 1
#include <pmmintrin.h>
#endif
#if (defined(_MSC_VER) || defined(__SSE4_1__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&         \
    !defined(SDL_DISABLE_SSE4_1)
#define SDL_SSE4_1_INTRINSICS 1
#include <smmintrin.h>
#endif
#if (defined(_MSC_VER) || defined(__SSE4_2__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&         \
    !defined(SDL_DISABLE_SSE4_2)
#define SDL_SSE4_2_INTRINSICS 1
#include <nmmintrin.h>
#endif
#if defined(__clang__) && (defined(_MSC_VER) || defined(__SCE__)) && \
    !defined(__AVX__) && !defined(SDL_DISABLE_AVX)
#define SDL_DISABLE_AVX /* see https://reviews.llvm.org/D20291 and \
                           https://reviews.llvm.org/D79194 */
#endif
#if (defined(_MSC_VER) || defined(__AVX__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&      \
    !defined(_M_ARM64EC) && !defined(SDL_DISABLE_AVX)
#define SDL_AVX_INTRINSICS 1
#include <immintrin.h>
#endif
#if defined(__clang__) && (defined(_MSC_VER) || defined(__SCE__)) && \
    !defined(__AVX2__) && !defined(SDL_DISABLE_AVX2)
#define SDL_DISABLE_AVX2 /* see https://reviews.llvm.org/D20291 and \
                            https://reviews.llvm.org/D79194 */
#endif
#if (defined(_MSC_VER) || defined(__AVX2__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&       \
    !defined(_M_ARM64EC) && !defined(SDL_DISABLE_AVX2)
#define SDL_AVX2_INTRINSICS 1
#include <immintrin.h>
#endif
#if defined(__clang__) && (defined(_MSC_VER) || defined(__SCE__)) && \
    !defined(__AVX512F__) && !defined(SDL_DISABLE_AVX512F)
#define SDL_DISABLE_AVX512F /* see https://reviews.llvm.org/D20291 and \
                               https://reviews.llvm.org/D79194 */
#endif
#if (defined(_MSC_VER) || defined(__AVX512F__) || \
     defined(SDL_HAS_TARGET_ATTRIBS)) &&          \
    !defined(_M_ARM64EC) && !defined(SDL_DISABLE_AVX512F)
#define SDL_AVX512F_INTRINSICS 1
#include <immintrin.h>
#endif
