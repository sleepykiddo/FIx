...
typedef struct SDL_IOStreamInterface {
     ...
     *
     *  The SDL_IOStream is still destroyed even if this fails, so clean up
     * anything even if flushing buffers, etc, returns an error.
     *
     *  \return true if successful or false on write error when flushing data.
     */
 ...
 * \sa SDL_WriteIO
 */
extern SDL_DECLSPEC SDL_IOStream* SDLCALL SDL_IOFromFile(const char* file,
                                                         const char* mode);
 ...
 * \sa SDL_TellIO
 */
extern SDL_DECLSPEC SDL_IOStream* SDLCALL SDL_IOFromConstMem(const void* mem,
                                                             size_t size);
...
#define SDL_PROP_IOSTREAM_DYNAMIC_CHUNKSIZE_NUMBER \
 ...
 * \sa SDL_IOFromMem
 */
extern SDL_DECLSPEC SDL_IOStream* SDLCALL
SDL_OpenIO(const SDL_IOStreamInterface* iface, void* userdata);
...
SDL_GetIOProperties(SDL_IOStream* context);
 ...
 * \sa SDL_TellIO
 */
extern SDL_DECLSPEC Sint64 SDLCALL SDL_SeekIO(SDL_IOStream* context,
                                              Sint64 offset,
                                              SDL_IOWhence whence);
 ...
 * \sa SDL_GetIOStatus
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_ReadIO(SDL_IOStream* context, void* ptr,
                                              size_t size);
 ...
 * \sa SDL_GetIOStatus
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_WriteIO(SDL_IOStream* context,
 ...
 * \sa SDL_WriteIO
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_IOprintf(
    SDL_IOStream* context, SDL_PRINTF_FORMAT_STRING const char* fmt, ...)
 ...
 * \sa SDL_WriteIO
 */
extern SDL_DECLSPEC size_t SDLCALL SDL_IOvprintf(
    SDL_IOStream* context, SDL_PRINTF_FORMAT_STRING const char* fmt, va_list ap)
 ...
 * \sa SDL_SaveFile_IO
 */
extern SDL_DECLSPEC void* SDLCALL SDL_LoadFile_IO(SDL_IOStream* src,
                                                  size_t* datasize,
                                                  bool closeio);
 ...
 * \sa SDL_SaveFile
 */
extern SDL_DECLSPEC void* SDLCALL SDL_LoadFile(const char* file,
                                               size_t* datasize);
 ...
 * \sa SDL_LoadFile_IO
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SaveFile_IO(SDL_IOStream* src,
                                                 const void* data,
                                                 size_t datasize, bool closeio);
 ...
 * \sa SDL_LoadFile
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SaveFile(const char* file,
                                              const void* data,
                                              size_t datasize);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU16LE(SDL_IOStream* src,
                                               Uint16* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS16LE(SDL_IOStream* src,
                                               Sint16* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU16BE(SDL_IOStream* src,
                                               Uint16* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS16BE(SDL_IOStream* src,
                                               Sint16* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU32LE(SDL_IOStream* src,
                                               Uint32* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS32LE(SDL_IOStream* src,
                                               Sint32* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU32BE(SDL_IOStream* src,
                                               Uint32* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS32BE(SDL_IOStream* src,
                                               Sint32* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU64LE(SDL_IOStream* src,
                                               Uint64* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS64LE(SDL_IOStream* src,
                                               Sint64* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadU64BE(SDL_IOStream* src,
                                               Uint64* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_ReadS64BE(SDL_IOStream* src,
                                               Sint64* value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU16LE(SDL_IOStream* dst,
                                                Uint16 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS16LE(SDL_IOStream* dst,
                                                Sint16 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU16BE(SDL_IOStream* dst,
                                                Uint16 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS16BE(SDL_IOStream* dst,
                                                Sint16 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU32LE(SDL_IOStream* dst,
                                                Uint32 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS32LE(SDL_IOStream* dst,
                                                Sint32 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU32BE(SDL_IOStream* dst,
                                                Uint32 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS32BE(SDL_IOStream* dst,
                                                Sint32 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU64LE(SDL_IOStream* dst,
                                                Uint64 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS64LE(SDL_IOStream* dst,
                                                Sint64 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteU64BE(SDL_IOStream* dst,
                                                Uint64 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WriteS64BE(SDL_IOStream* dst,
                                                Sint64 value);
