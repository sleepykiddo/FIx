...
SDL_GetJoystickNameForID(SDL_JoystickID instance_id);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetJoystickPathForID(SDL_JoystickID instance_id);
...
SDL_GetJoystickPlayerIndexForID(SDL_JoystickID instance_id);
...
SDL_GetJoystickVendorForID(SDL_JoystickID instance_id);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetJoystickProductForID(SDL_JoystickID instance_id);
 ...
 * \sa SDL_GetJoysticks
 */
extern SDL_DECLSPEC SDL_JoystickType SDLCALL
SDL_GetJoystickTypeForID(SDL_JoystickID instance_id);
 ...
 */
extern SDL_DECLSPEC SDL_Joystick* SDLCALL
SDL_GetJoystickFromPlayerIndex(int player_index);
...
typedef struct SDL_VirtualJoystickDesc {
    ...
    Uint16 ntouchpads;  /**< the number of touchpads on this joystick, requires
                           `touchpads` to point at valid descriptions */
    Uint16 nsensors;    /**< the number of sensors on this joystick, requires
                           `sensors` to point at valid descriptions */
    Uint16 padding2[2]; /**< unused */
    Uint32 button_mask; /**< A mask of which buttons are valid for this
                           controller e.g. (1 << SDL_GAMEPAD_BUTTON_SOUTH) */
    Uint32 axis_mask;   /**< A mask of which axes are valid for this controller
                             e.g. (1 << SDL_GAMEPAD_AXIS_LEFTX) */
    const char* name;   /**< the name of the joystick */
    const SDL_VirtualJoystickTouchpadDesc*
        touchpads; /**< A pointer to an array of touchpad descriptions, required
                      if `ntouchpads` is > 0 */
    const SDL_VirtualJoystickSensorDesc*
        sensors; /**< A pointer to an array of sensor descriptions, required if
                    `nsensors` is > 0 */

    void* userdata; /**< User data pointer passed to callbacks */
    void(SDLCALL* Update)(void* userdata); /**< Called when the joystick state
                                              should be updated */
    ...
    bool(SDLCALL* Rumble)(
        ...
        Uint16 high_frequency_rumble); /**< Implements SDL_RumbleJoystick() */
    bool(SDLCALL* RumbleTriggers)(
        void* userdata, Uint16 left_rumble,
        Uint16 right_rumble); /**< Implements SDL_RumbleJoystickTriggers() */
    bool(SDLCALL* SetLED)(void* userdata, Uint8 red, Uint8 green,
                          Uint8 blue); /**< Implements SDL_SetJoystickLED() */
    bool(SDLCALL* SendEffect)(
        void* userdata, const void* data,
        int size); /**< Implements SDL_SendJoystickEffect() */
    bool(SDLCALL* SetSensorsEnabled)(
        void* userdata,
        bool enabled); /**< Implements SDL_SetGamepadSensorEnabled() */
    void(SDLCALL* Cleanup)(void* userdata); /**< Cleans up the userdata when the
...
SDL_AttachVirtualJoystick(const SDL_VirtualJoystickDesc* desc);
...
SDL_DetachVirtualJoystick(SDL_JoystickID instance_id);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetJoystickVirtualAxis(SDL_Joystick* joystick, int axis, Sint16 value);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetJoystickVirtualBall(
    SDL_Joystick* joystick, int ball, Sint16 xrel, Sint16 yrel);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetJoystickVirtualButton(SDL_Joystick* joystick, int button, bool down);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetJoystickVirtualHat(SDL_Joystick* joystick, int hat, Uint8 value);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetJoystickVirtualTouchpad(SDL_Joystick* joystick, int touchpad, int finger,
...
extern SDL_DECLSPEC bool SDLCALL SDL_SendJoystickVirtualSensorData(
    SDL_Joystick* joystick, SDL_SensorType type, Uint64 sensor_timestamp,
    const float* data, int num_values);
...
SDL_GetJoystickProperties(SDL_Joystick* joystick);
...
#define SDL_PROP_JOYSTICK_CAP_TRIGGER_RUMBLE_BOOLEAN \
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetJoystickName(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetJoystickPath(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetJoystickPlayerIndex(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_SetJoystickPlayerIndex(SDL_Joystick* joystick, int player_index);
 ...
 */
extern SDL_DECLSPEC SDL_GUID SDLCALL
SDL_GetJoystickGUID(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetJoystickVendor(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetJoystickProduct(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetJoystickProductVersion(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC Uint16 SDLCALL
SDL_GetJoystickFirmwareVersion(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC const char* SDLCALL
SDL_GetJoystickSerial(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC SDL_JoystickType SDLCALL
SDL_GetJoystickType(SDL_Joystick* joystick);
 ...
 */
extern SDL_DECLSPEC int SDLCALL
SDL_GetNumJoystickButtons(SDL_Joystick* joystick);
 ...
 * \sa SDL_GetNumJoystickAxes
 */
extern SDL_DECLSPEC Sint16 SDLCALL SDL_GetJoystickAxis(SDL_Joystick* joystick,
                                                       int axis);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetJoystickAxisInitialState(
 ...
 * \sa SDL_GetNumJoystickBalls
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetJoystickBall(SDL_Joystick* joystick,
                                                     int ball, int* dx,
                                                     int* dy);
 ...
 * \sa SDL_GetNumJoystickHats
 */
extern SDL_DECLSPEC Uint8 SDLCALL SDL_GetJoystickHat(SDL_Joystick* joystick,
                                                     int hat);
 ...
 * \sa SDL_GetNumJoystickButtons
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetJoystickButton(SDL_Joystick* joystick,
                                                       int button);
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_RumbleJoystickTriggers(SDL_Joystick* joystick, Uint16 left_rumble,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetJoystickLED(SDL_Joystick* joystick,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SendJoystickEffect(SDL_Joystick* joystick,
                                                        const void* data,
                                                        int size);
...
SDL_GetJoystickConnectionState(SDL_Joystick* joystick);
...
SDL_GetJoystickPowerInfo(SDL_Joystick* joystick, int* percent);
