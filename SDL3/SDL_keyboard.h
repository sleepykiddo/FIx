...
SDL_GetKeyboardNameForID(SDL_KeyboardID instance_id);
 ...
 */
extern SDL_DECLSPEC SDL_Keycode SDLCALL SDL_GetKeyFromScancode(
    SDL_Scancode scancode, SDL_Keymod modstate, bool key_event);
 ...
 */
extern SDL_DECLSPEC SDL_Scancode SDLCALL
SDL_GetScancodeFromKey(SDL_Keycode key, SDL_Keymod* modstate);
 ...
 * \sa SDL_GetScancodeName
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetScancodeName(SDL_Scancode scancode,
                                                     const char* name);
...
typedef enum SDL_TextInputType {
    ...
    SDL_TEXTINPUT_TYPE_TEXT_PASSWORD_HIDDEN, /**< The input is a secure password
                                                that is hidden */
    SDL_TEXTINPUT_TYPE_TEXT_PASSWORD_VISIBLE,  /**< The input is a secure
                                                  password that is visible */
    SDL_TEXTINPUT_TYPE_NUMBER,                 /**< The input is a number */
    SDL_TEXTINPUT_TYPE_NUMBER_PASSWORD_HIDDEN, /**< The input is a secure PIN
                                                  that is hidden */
...
SDL_StartTextInputWithProperties(SDL_Window* window, SDL_PropertiesID props);
...
#define SDL_PROP_TEXTINPUT_ANDROID_INPUTTYPE_NUMBER \
 ...
 * \sa SDL_StartTextInput
 */
extern SDL_DECLSPEC bool SDLCALL SDL_SetTextInputArea(SDL_Window* window,
                                                      const SDL_Rect* rect,
                                                      int cursor);
 ...
 * \sa SDL_SetTextInputArea
 */
extern SDL_DECLSPEC bool SDLCALL SDL_GetTextInputArea(SDL_Window* window,
                                                      SDL_Rect* rect,
                                                      int* cursor);
