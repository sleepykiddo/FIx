...
SDL_SetLogPriorityPrefix(SDL_LogPriority priority, const char* prefix);
 ...
 * \sa SDL_LogWarn
 */
extern SDL_DECLSPEC void SDLCALL SDL_Log(
...
SDL_LogTrace(int category, SDL_PRINTF_FORMAT_STRING const char* fmt, ...)
 ...
 * \sa SDL_LogWarn
 */
extern SDL_DECLSPEC void SDLCALL SDL_LogMessage(
 ...
 */
extern SDL_DECLSPEC SDL_LogOutputFunction SDLCALL
SDL_GetDefaultLogOutputFunction(void);
