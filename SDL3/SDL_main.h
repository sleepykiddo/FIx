...
#if __has_include("SDL_main_private.h") && \
                  __has_include("SDL_main_impl_private.h")
 ...
 * \sa SDL_AppQuit
 */
extern SDLMAIN_DECLSPEC SDL_AppResult SDLCALL SDL_AppInit(void** appstate,
                                                          int argc,
                                                          char* argv[]);
 ...
 * \sa SDL_AppIterate
 */
extern SDLMAIN_DECLSPEC SDL_AppResult SDLCALL SDL_AppEvent(void* appstate,
                                                           SDL_Event* event);
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC int SDLCALL SDL_RunApp(int argc, char* argv[],
...
SDL_EnterAppMainCallbacks(int argc, char* argv[], SDL_AppInit_func appinit,
 ...
 * \since This function is available since SDL 3.2.0.
 */
extern SDL_DECLSPEC bool SDLCALL SDL_RegisterApp(const char* name, Uint32 style,
                                                 void* hInst);
