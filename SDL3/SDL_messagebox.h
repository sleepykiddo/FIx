...
#define SDL_MESSAGEBOX_BUTTONS_LEFT_TO_RIGHT \
    0x00000080u /**< buttons placed left to right */
#define SDL_MESSAGEBOX_BUTTONS_RIGHT_TO_LEFT \
    0x00000100u /**< buttons placed right to left */
...
#define SDL_MESSAGEBOX_BUTTON_RETURNKEY_DEFAULT \
    0x00000001u /**< Marks the default button when return is hit */
#define SDL_MESSAGEBOX_BUTTON_ESCAPEKEY_DEFAULT \
    0x00000002u /**< Marks the default button when escape is hit */
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_ShowSimpleMessageBox(SDL_MessageBoxFlags flags, const char* title,
