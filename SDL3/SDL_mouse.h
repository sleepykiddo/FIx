...
typedef enum SDL_SystemCursor {
    ...
    SDL_SYSTEM_CURSOR_WAIT, /**< Wait. Usually an hourglass or watch or spinning
                               ball. */
    SDL_SYSTEM_CURSOR_CROSSHAIR,   /**< Crosshair. */
    SDL_SYSTEM_CURSOR_PROGRESS,    /**< Program is busy but still interactive.
    ...
    SDL_SYSTEM_CURSOR_MOVE, /**< Four pointed arrow pointing north, south, east,
                               and west. */
    SDL_SYSTEM_CURSOR_NOT_ALLOWED, /**< Not permitted. Usually a slashed circle
                                      or crossbones. */
    SDL_SYSTEM_CURSOR_POINTER,     /**< Pointer that indicates a link. Usually a
                                      pointing hand. */
    SDL_SYSTEM_CURSOR_NW_RESIZE,   /**< Window resize top-left. This may be a
...
SDL_GetMouseNameForID(SDL_MouseID instance_id);
 ...
 * \sa SDL_GetRelativeMouseState
 */
extern SDL_DECLSPEC SDL_MouseButtonFlags SDLCALL SDL_GetMouseState(float* x,
                                                                   float* y);
 ...
 * \sa SDL_GetGlobalMouseState
 */
extern SDL_DECLSPEC SDL_MouseButtonFlags SDLCALL
 ...
 */
extern SDL_DECLSPEC bool SDLCALL
SDL_GetWindowRelativeMouseMode(SDL_Window* window);
 ...
 * \sa SDL_SetCursor
 */
extern SDL_DECLSPEC SDL_Cursor* SDLCALL
