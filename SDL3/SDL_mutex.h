...
#elif defined(SDL_THREAD_SAFETY_ANALYSIS) && defined(__clang__) && \
    (!defined(SWIG))
#define SDL_THREAD_ANNOTATION_ATTRIBUTE__(x) __attribute__((x))
#else
 ...
 * \sa SDL_UnlockMutex
 */
extern SDL_DECLSPEC void SDLCALL SDL_LockMutex(SDL_Mutex* mutex)
    SDL_ACQUIRE(mutex);
 ...
 * \sa SDL_UnlockMutex
 */
extern SDL_DECLSPEC bool SDLCALL SDL_TryLockMutex(SDL_Mutex* mutex)
 ...
 * \sa SDL_TryLockMutex
 */
extern SDL_DECLSPEC void SDLCALL SDL_UnlockMutex(SDL_Mutex* mutex)
    SDL_RELEASE(mutex);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC void SDLCALL SDL_LockRWLockForReading(SDL_RWLock* rwlock)
    SDL_ACQUIRE_SHARED(rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC void SDLCALL SDL_LockRWLockForWriting(SDL_RWLock* rwlock)
    SDL_ACQUIRE(rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC bool SDLCALL SDL_TryLockRWLockForReading(SDL_RWLock* rwlock)
    SDL_TRY_ACQUIRE_SHARED(0, rwlock);
 ...
 * \sa SDL_UnlockRWLock
 */
extern SDL_DECLSPEC bool SDLCALL SDL_TryLockRWLockForWriting(SDL_RWLock* rwlock)
    SDL_TRY_ACQUIRE(0, rwlock);
 ...
 * \sa SDL_TryLockRWLockForWriting
 */
extern SDL_DECLSPEC void SDLCALL SDL_UnlockRWLock(SDL_RWLock* rwlock)
    SDL_RELEASE_GENERIC(rwlock);
 ...
 */
extern SDL_DECLSPEC SDL_Semaphore* SDLCALL
 ...
 * \sa SDL_WaitSemaphore
 */
extern SDL_DECLSPEC bool SDLCALL SDL_WaitSemaphoreTimeout(SDL_Semaphore* sem,
                                                          Sint32 timeoutMS);
 ...
 * \sa SDL_WaitConditionTimeout
 */
extern SDL_DECLSPEC void SDLCALL SDL_WaitCondition(SDL_Condition* cond,
                                                   SDL_Mutex* mutex);
 ...
 * \sa SDL_ShouldQuit
 */
extern SDL_DECLSPEC void SDLCALL SDL_SetInitialized(SDL_InitState* state,
                                                    bool initialized);
